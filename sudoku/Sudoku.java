public class Sudoku {
    ...
    static boolean notValid(int i, int j, int val, int[][] cells)
	 {
		...
		return true; // no violations, so it's notValid
       }

    static int[][] readInput(String[] args) 
	{
