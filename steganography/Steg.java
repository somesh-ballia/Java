  ...
  public mainframe()throws Exception
   {
    ...
    Ldesign=new JLabel("Designed By : B.Rajavel");
...
Exception
   {
    ...
    OutputStream outs=new FileOutputStream(new File("c:/pop8.wav"));
    for(int c=0;c<key;c++)
     {
      int ch=ins.read();
      outs.write(ch);
    ...
    if(ae.getSource()==Bencrypt)
     {
      if(Copened==1)
       {
        Ekey=JOptionPane.showInputDialog("Enter The Key ForEncryption");
//String type
        if(Ekey.trim().equals(""))
       ...
       {
        JOptionPane.showMessageDialog(this,"FileNotOpened","Error",JOptionPane.ERROR_MESSAGE);
       }
     } // end of Bencrypt
...
// Action for Decrypt button
    ...
    else if(ae.getSource()==Bdecrypt)
     {
      if(Copened==1)
       {
        Dkey=JOptionPane.showInputDialog("Enter The Key ForDecryption");
//String type
        if(Dkey.trim().equals(""))
         JOptionPane.showMessageDialog(this,"EntertheKey","Error",JOptionPane.ERROR_MESSAGE);
        else
...
// Action for Stop button
    ...
    else if(ae.getSource()==Bstop)
     {
      ...
      if(Cplay==1)
       ...
       JOptionPane.showMessageDialog(this,"No AudioIsplaying","Error",JOptionPane.ERROR_MESSAGE);
      ...
      if(r==JFileChooser.CANCEL_OPTION)
      ...
      else
       {
        ...
        if(!(name.endsWith(".wav")))
          ...
          JOptionPane.showMessageDialog(this,"SelectOnlyWav","Error",JOptionPane.ERROR_MESSAGE);
      ...
      if(Copened==1 && Cencrypt==1 || Cdecrypt==1)
       {
        ...
        InputStream in=new FileInputStream("c:/pop8.wav");
